...
class ApiResponse extends AbstractApiResponse
{
     ...
     * @var Request
     *
     * @JMS\Type("Speicher210\Fastbill\Api\Service\Subscription\SetUsageData\Request")
     ...
     * @var array
     *
     * @JMS\Type("Speicher210\Fastbill\Api\Service\Subscription\SetUsageData\Response")
